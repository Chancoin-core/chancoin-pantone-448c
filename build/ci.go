...
import (
	...
	"github.com/chancoin-core/chancoin-pantone-448c/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/chancoin-core/chancoin-pantone-448c/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/chancoin-core/chancoin-pantone-448c/mobile")
